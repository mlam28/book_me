...
Venue.all.each do |venue|
    5.times {Booking.create(title: Faker::Hipster.words(number: 3).join(' ').titleize, artist: Artist.all.shuffle.first, venue: venue, start_date: DateTime.new(2019, 8, 20, 19, 30), 
